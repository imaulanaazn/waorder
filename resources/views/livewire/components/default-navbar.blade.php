 <div x-data="{ mobileNavOpen: false }">
     <nav class="py-4 md:py-6 lg:py-9 bg-teal-900">
             ...
             <div class="relative flex items-center justify-between">
                 ...
                 <div class="relative w-3/4 md:w-3/5 lg:w-2/5 xl:w-3/5 transition-all">
                     <input
                         ...
                         id="searchInput"
                         class="w-full py-2 pl-12 pr-4 text-white/80 bg-transparent focus:bg-white/10 border rounded-full outline-none transition-all border-white/80 placeholder:text-white/80" />
                     <div class="absolute inset-y-0 left-0 flex items-center pl-5">
                         <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white/80 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <div class="flex items-center justify-end">
                     <div class="hidden lg:flex! items-center gap-8">
                         <div class="flex gap-4">
                             <div class="dropdown-wrapper group relative hover:cursor-pointer">
                                 <i class="fa-solid fa-cart-plus text-xl text-white group-hover:text-white/60" aria-hidden="true"></i>
                         ...
                         <div class="bg-white/40! w-0.5 h-6"></div>
                         @if(!Auth::user())
                         <div class="flex gap-3">
                             <a class="inline-flex py-1.5 px-4 items-center justify-center text-lime-500 border border-lime-500 hover:border-white bg-transparent hover:bg-white rounded-lg transition duration-200" href="/login">Masuk</a>
                             <a class="inline-flex py-1.5 px-4 items-center justify-center text-teal-900 border border-lime-500 hover:border-white bg-lime-500 hover:bg-white rounded-lg transition duration-200" href="/register">Daftar</a>
                         </div>
                         @else
                         <div class="dropdown-wrapper group relative hover:cursor-pointer">
                             <a href="" class="flex gap-2 items-center">
                                 <div class="flex group w-7 h-auto aspect-square items-center justify-center text-sm font-medium text-white hover:text-teal-900 border border-white group-hover:border-white/60 rounded-full transition duration-200">
                                     <i class="fa-solid fa-store text-xs group-hover:text-white/60"></i>
                                 </div>
                                 <p class="text-white group-hover:text-white/60">Toko</p>
                             </a>
                         ...
                         <a href="{{route('user.settings')}}" class="flex gap-2 items-center group">
                             <div class="flex w-7 h-auto aspect-square items-center justify-center text-sm font-medium text-white hover:text-teal-900 border border-white group-hover:border-white/60 rounded-full transition duration-200">
                                 <i class="fa-solid fa-user text-xs group-hover:text-white/60"></i>
                             </div>
                             <p class="text-white group-hover:text-white/60">{{ucfirst(Auth::user()->name)}}</p>
                         </a>
                         @endif
                     </div>
                     <div class="flex lg:hidden gap-3">
                         <a href="" class="flex">
                             <i class="fa-solid fa-cart-plus text-xl text-white flex! items-center! justify-center!" aria-hidden="true"></i>
                         </a>
                         <!-- <button class="text-white hover:text-lime-500" x-on:click="mobileNavOpen = !mobileNavOpen">
